...
Definition CatFun090. A covariant functor is a map between categories F such that

  F satisfies Fun1 and

  F satisfies Fun2 and

  F satisfies Fun3 and

  F satisfies Fun4 and

  F satisfies Fun5.


Definition CatFun095. A contravariant functor is a map between categories F such that
  ...
  F satisfies Fun6 and

  F satisfies Fun7.


Let a functor stand for a covariant functor.
...
Definition CatFun200. Let C be a category. A subcategory of C is a substructure D of C such that
D is a category and the inclusion of D into C is a functor between C and D.
