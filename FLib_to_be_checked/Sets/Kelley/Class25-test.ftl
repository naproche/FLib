...
Lemma. Assume [a,c] \in r \circ s. Then there is b 
such that [a,b] \in s and [b,c] \in r.
Proof. Take objects k,b,m such that [k,b] \in s and [b,m] \in r and [a,c] = [k,m].
Then a = k and c = m.
qed.

Theorem 58. (r \circ s) \circ t = r \circ (s \circ t).
Proof. 
(1) (r \circ s) \circ t \subset r \circ (s \circ t).
Proof. Let z \in (r \circ s) \circ t.
Take a,d such that z = [a,d].
Take b,c such that [a,b] \in t and [b,c] \in s and [c,d] \in r.
Then [a,c] \in s \circ t and z =  [a,d] \in  r \circ (s \circ t).
qed.
(2) r \circ (s \circ t) \subset (r \circ s) \circ t.
Proof. Let z \in r \circ (s \circ t).
Take a,d such that z = [a,d].
Take c such that [a,c] \in s \circ t and [c,d] \in r.
Take b such that [a,b] \in t and [b,c] \in s.
Then [b,d] \in r \circ s and z = [a,d] \in (r \circ s) \circ t.
qed.
QED. 

Theorem 59a. r \circ (s \cup t) = (r \circ s) \cup (r \circ t).
Proof. 
(1) r \circ (s \cup t) \subset (r \circ s) \cup (r \circ t).
Proof. Let z \in r \circ (s \cup t).
Take a,c such that z = [a,c].
...
Proof. Let z \in (r \circ s) \cup (r \circ t).
Take a,c such that z = [a,c].
Case z \in r \circ s. end.
Case z \in r \circ t. end.
qed.
qed.
...
# Proof. Let a,b,c be objects. Assume that [a,b], [a,c] \in f \circ g.
