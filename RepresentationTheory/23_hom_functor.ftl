...
Proof.
 ...
 and all g << Mod(K,A)(N2,N3) : F(g*f) = F(g)*F(f).
  ...
  g*f << Mod(K,A)(N1,N3).
  F(g*f) << Mod(K,K)(F(N1),F(N3)).
  F(g*f) < Hom(K,K,F(N1),F(N3)).
...
# Up to here (including all necessary proofs): 5:20 minutes.