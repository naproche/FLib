...
\begin{document}
  ...
  \begin{forthel}
    \begin{proposition}[SF 02 04 657921]
      ...
      Then
      $$f[a \symdiff a'] \supseteq f[a] \symdiff f[a'].$$
    \end{proposition}
    \begin{proof}
      Let $v \in f[a] \symdiff f[a']$.
      Then $v \in f[a] \cup f[a']$ and $v \notin f[a] \cap f[a']$.
      We have $f[a] \cup f[a'] = f[a \cup a']$.
      Hence we can take $u \in a \cup a'$ such that $v = f(u)$.
    ...
    \begin{proposition}[SF 02 04 661750]
      ...
      Then
      $$f^{-}[b \symdiff b'] \supseteq f^{-}[b] \symdiff f^{-}[b'].$$
    \end{proposition}
    \begin{proof}
