...
\begin{document}
  ...
  \begin{forthel}
    ...
    \end{proposition}
    \begin{proof}
      Define $P = \{ "natural number" n : "if" n > 1 "then" n "has a prime divisor" \}$.
    ...
    \end{proposition}
    \begin{proof}
      Define $A = \{ "natural number" m : m "is a nontrivial divisor of" n \}$.
    ...
    \begin{proposition}[NN 03 03 703692]
      Let $p$ be a prime number.
      Then
      $$p \mid n \cdot m \implies (p \mid n "or" p \mid m).$$
    \end{proposition}
    \begin{proof}
    ...
    \begin{proof}
      ...
      Case $k > 1$.
        (1) Define $P = \{ "natural number" n : "for all natural numbers" m "if" n "and" m "are nonzero and" k \cdot m^{2} = n^{2} "then" k "is compound" \}$.
        ...
        Let us show that for all natural numbers $n$ if $P$ contains all predecessors of $n$ then $P$ contains $n$.
          ...
          (1) Then $m^{2} = k \cdot l^{2}$ (by NN 01 03 169506).
          Indeed $k \cdot m^{2} = (k \cdot l)^{2} = k \cdot (k \cdot l^{2})$.

          (2) $m$ is an element of $P$.
          Proof.
          ...
          Therefore $k$ is compound (by 1, 2, 3, 4).
          Contradiction.
        End.
