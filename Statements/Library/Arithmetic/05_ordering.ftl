...
Definition 0501. n is positive iff n \neq 0.

Definition 0502. n < m iff there exists a positive natural number k such that
m = n + k. Let x is less than y stand for x < y. Let x > y stand for y < x. Let
x is greater than y stand for x > y.

Definition 0503. n \leq m iff there exists a natural number k such that
m = n + k. Let x is less than or equal to y stand for x \leq y. Let x \geq y
stand for y \leq x. Let x is greater than or equal to y stand for x \geq y.
...
Proof.
  ...
  If 0 \neq n then 0 < n.
  proof.
    Assume 0 \neq n. Then we can take a natural number k such that n = k + 1.
...
Proposition 0507. If n < m then n \neq m.
...
Proof.
  [prove off]
  # Define P(y) iff for all natural numbers x we have x < y or x = y or x > y.
...
Proof.
  ...
  proof.
    ...
    m + k = (n + l) + k. Thus m = n + l. Therefore n < m.
  end.
qed.
...
Proposition 0520. Assume k \neq 0. n < m iff n \cdot k < m \cdot k.
...
Proof.
  ...
  proof.
    [prove off]
    # Define P(x) iff for all natural numbers y,z if x \cdot z < y \cdot z then
    # x < y.
...
Corollary 0521. Assume k \neq 0. n < m iff k \cdot n < k \cdot m.
...
Proof.
  [prove off]
  # Define P(x) iff if x,m > k then x \cdot m > k.
  ...
  proof.
    ...
    proof.
      ...
      (x \cdot m) + m = 0 + m = m > k. If x \neq 0 then (x \cdot m) + m > m > k.
      Hence (x + 1) \cdot m > k.
    end.
  end.
...
Corollary 0523. Assume k \neq 0. n \leq m iff k \cdot n \leq k \cdot m.


Corollary 0524. Assume k \neq 0. n \leq m iff n \cdot k \leq m \cdot k.


# < is stable under exponentiation

Proposition 0525. Assume k \neq 0. n < m iff n^{k} < m^{k}.
...
Proof.
  ...
  proof.
    ...
    Case k \neq 1.
      ...
      [prove off]
      # Define P(z) iff for all natural numbers x,y if x < y and z > 1 then
      # x^{z} < y^{z}.
      ...
      proof.
        ...
        proof.
          ...
          Case z > 1.
            Case x = 0.
              Then y \neq 0. Hence x^{z + 1} = 0 < y^{z} \cdot y = y^{z + 1}.
              Thus x^{z + 1} < y^{z + 1}.
            end.

            Case x \neq 0.
              Then x^{z} \cdot x < y^{z} \cdot x < y^{z} \cdot y (by 0520, 0521,
              0403). Indeed y^{z} \neq 0. Hence x^{z + 1} = x^{z} \cdot x <
              y^{z} \cdot x < y^{z} \cdot y = y^{z + 1}. Thus x^{z + 1} <
              y^{z + 1} (by 0509, 0303, 0403).
            end.
          end.
  ...
  proof.
    [prove off]
    # Define P(z) iff for all natural numbers x,y if x \geq y then
    # x^{z} \geq y^{z}
...
Corollary 0526. Assume k \neq 0. If n^{k} = m^{k} then n = m.

Proof.
  Assume n \neq m. Then n < m or m < n. If n < m then n^{k} < m^{k}. If m < n
  then m^{k} < n^{k}. Thus n^{k} \neq m^{k}. Hence the thesis.
qed.
...
Proof.
  ...
  proof.
    [prove off]
    # Define P(y) iff for all natural numbers x,z if z > 1 and x < y then
    # z^{x} < z^{y}
    ...
    proof.
      ...
      proof.
        ...
        We have z^{y} \cdot 1 < z^{y} \cdot z (by 0403, 0521). Indeed
        z^{y} \neq 0.
  ...
  proof.
    [prove off]
    # Define P(x) iff for all natural numbers y,z if x \geq y then
    # z^{x} \geq z^{y} or z \leq 1
    ...
    proof.
      ...
      proof.
        ...
        Case x + 1 > y.
          ...
          Case z^{x} \geq z^{y}.
            We have z^{x} \cdot 1 \leq z^{x} \cdot z (by 0403, 0523). Indeed
            1 \leq z and z^{x} \neq 0. Hence z^{y} \leq z^{x} = z^{x} \cdot 1
            \leq z^{x} \cdot z = z^{x + 1}.
          end.
        end.
      end.
...
Proof.
  Assume n \neq m. Then n < m or m < n. If n < m then k^{n} < k^{m}. If m < n
  then k^{m} < k^{n}. Thus k^{n} \neq k^{m}. Hence the thesis.
qed.
...
Proof.
  ...
  proof.
    ...
    Case k,l \neq 1.
      ...
      k,l \neq 0. Hence k = a + 1 and l = b + 1. Thus k,l > 1. Indeed a,b are
      positive.
    end.
  end.
